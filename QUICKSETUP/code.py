#antivirus software cannot detect or defend against this attack
#host machine cannot scan usb device firmware
#can be a serial device or an ethernet adapter or modem or etc.
